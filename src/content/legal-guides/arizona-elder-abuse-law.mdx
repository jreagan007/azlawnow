---
title: "Arizona Elder Abuse Laws: ARS 46-451 Definitions + Mandatory Reporting"
description: "Arizona elder abuse laws explained: ARS 46-451 defines abuse/neglect/exploitation; ARS 46-454 requires mandatory reporting or faces Class 1 misdemeanor. Financial exploitation over $1K is a Class 2 felony. Statewide intake (602) 654-0202."
...
faqs:
  - question: "What qualifies as elder abuse under Arizona law?"
    answer: "ARS 46-451 defines abuse of a vulnerable adult as the intentional infliction of physical harm, injury caused by negligent acts or omissions, unreasonable confinement (including chemical restraint), and sexual abuse. The statute also covers neglect (deprivation of necessities), exploitation (financial or otherwise), and emotional abuse."
  - question: "Who is required to report elder abuse in Arizona?"
    answer: "ARS 46-454 mandates reporting by healthcare providers, nurses, hospital and nursing home administrators, social workers, counselors, peace officers, firefighters, guardians, conservators, clergy, and anyone else with care responsibility for a vulnerable adult. Failure to report is a Class 1 misdemeanor."
  - question: "How do I report suspected nursing home abuse in Arizona?"
    answer: "Call Arizona Adult Protective Services at 1-877-767-2385. You should also file a complaint with the Arizona Department of Health Services for facility-level issues and contact local law enforcement if you believe a crime has been committed. Report to all three."
  - question: "What's the statute of limitations for an elder abuse lawsuit?"
    answer: "Two years from the date the cause of action accrues under ARS 12-542. The discovery rule may delay accrual when the resident or family didn't know and couldn't reasonably have known about the harm. Don't wait for the deadline to approach before consulting an attorney."
  - question: "Can I sue a nursing home and press criminal charges at the same time?"
    answer: "Yes. Civil and criminal cases proceed independently. A civil lawsuit seeks monetary compensation and is controlled by the family's attorney. Criminal charges are filed by the county attorney or attorney general. You don't need a criminal conviction to win a civil case."
  - question: "What is financial exploitation of a vulnerable adult?"
  ...
  - question: "What does APS do after I file a report?"
    answer: "APS assigns an investigator who interviews the vulnerable adult, the alleged abuser, and witnesses. They can access the living environment and request medical records. The investigation results in a finding of substantiated, unsubstantiated, or inconclusive. APS can seek emergency protective orders and refer cases for criminal prosecution."
  - question: "Can a nursing home retaliate against me for reporting abuse?"
    answer: "No. ARS 46-454 provides immunity for good-faith reporters. The statute protects you from civil liability and retaliation. If a facility retaliates against a family member or employee for reporting, that retaliation itself creates additional legal liability."
  - question: "Are punitive damages available in elder abuse cases?"
    answer: "Yes. Arizona allows punitive damages when the defendant's conduct demonstrates an \"evil mind\" or conscious disregard for safety. Nursing homes that knowingly understaff to maximize profit while residents suffer harm can face punitive damages in addition to compensatory damages."
  - question: "What if my family member has dementia and can't describe the abuse?"
    answer: "The case doesn't depend solely on the resident's testimony. Evidence can include medical records showing unexplained injuries, staffing logs, CMS deficiency citations, APS investigation findings, testimony from other staff or residents, and expert medical opinions. Families should document behavioral changes, physical symptoms, and any statements the resident makes."
---
...
<DataTable
  headers={["Exploitation type", "How it works"]}
  rows={[
...
<DataTable
  headers={["Damage category", "What it covers"]}
  rows={[
