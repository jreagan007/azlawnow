---
title: "Arizona Motorcycle Laws: ARS 28-964 Helmet Rule, Insurance + Comparative Fault"
description: "Arizona motorcycle laws explained: ARS 28-964 requires helmets under 18 only; ARS 28-4135 sets 25/50/15 minimums; ARS 12-2505 pure comparative fault. Lane splitting illegal. Statewide intake (602) 654-0202."
...
faqs:
  - question: "Do I have to wear a helmet to ride a motorcycle in Arizona?"
    answer: "Only if you're under 18. ARS 28-964 requires helmets for riders and passengers under 18 only. Adult riders can legally choose not to wear a helmet, though doing so significantly increases the risk of fatal head injuries and can affect personal injury recovery."
  - question: "What's the minimum motorcycle insurance in Arizona?"
    answer: "Arizona requires the same minimum liability coverage for motorcycles as for cars: 25/50/15 ($25,000 bodily injury per person, $50,000 per accident, $15,000 property damage). These minimums are dangerously low for motorcycle crashes given typical injury costs."
  - question: "Is lane splitting legal in Arizona?"
    answer: "No. Arizona prohibits lane splitting and lane filtering. Riders can be cited for the violation and the conduct can be used as evidence of comparative fault if a crash occurs."
  - question: "How does comparative fault work in Arizona motorcycle cases?"
    answer: "Arizona uses pure comparative fault under ARS 12-2505. A jury assigns a percentage of fault to each party. Your damages are reduced by your percentage of fault but you can recover even if you're more than 50% responsible. Insurance defense lawyers focus heavily on assigning fault to motorcyclists, so documentation and legal representation matter."
  - question: "How long do I have to file a motorcycle injury lawsuit in Arizona?"
    answer: "Two years from the date of the crash, under ARS 12-542. Minors have until two years after their 18th birthday under ARS 12-502 (minority tolling). Wrongful death claims accrue at death."
---
