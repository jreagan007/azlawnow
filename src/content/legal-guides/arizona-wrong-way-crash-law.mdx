...
**Bar surveillance footage.** Most establishments retain security camera footage for 7 to 30 days before overwriting. A preservation letter must go out within days of the crash.

**Credit card and POS records.** Receipts and point-of-sale records show what was ordered, when, and how much. These records can demonstrate the volume of alcohol served and the timeframe.

**Server testimony.** The server or bartender who served the driver is a key witness. Their recollection of the patron's behavior, appearance, and condition at the time of service is central.
...
This creates a gap in the law. A bartender who serves an obviously drunk person faces civil liability for the resulting crash. A party host who hands the same person their tenth beer and watches them drive away doesn't. Arizona's Legislature has not extended dram shop-style liability to social hosts, and the Arizona Supreme Court hasn't done so by case law.
...
**Beneficiary priority.** The surviving spouse and children have first priority. Parents are second. The personal representative is third (ARS 12-612).

**No damage caps.** The Arizona Constitution prohibits caps on death damages. A wrongful death jury in a wrong-way crash case can award compensatory and punitive damages without any statutory ceiling.

**Multiple defendants.** The drunk driver, the bar that served them, and potentially the social host who served a minor all share liability. Multiple defendants mean multiple insurance policies.
...
**BAC testing.** Blood draws at the hospital produce the most reliable BAC evidence. Arizona's implied consent law (ARS 28-1321) allows law enforcement to obtain blood samples from drivers involved in crashes causing serious injury or death. If the driver refuses, a warrant is obtained.

**Bar receipts and credit card records.** These establish where the driver was drinking, what they consumed, and over what period.

**Surveillance footage.** Security cameras at establishments, parking lots, gas stations, and traffic intersections can track the driver's movements and condition before the crash.

**Toxicology reports.** Beyond BAC, toxicology testing can identify drugs in the driver's system. Wrong-way crashes sometimes involve combined alcohol and drug impairment, which can amplify the degree of incapacitation.

**Phone records.** Call logs, text messages, and GPS data from the driver's phone can establish the timeline of the evening and identify potential witnesses.

**ADOT wrong-way detection data.** ADOT's wrong-way detection system on I-17 and other instrumented corridors records when sensors are triggered. This data can establish the exact time and location the wrong-way entry occurred.

**Freeway camera footage.** ADOT's freeway management system cameras may capture the wrong-way vehicle on the highway.
