---
title: "Arizona Wrongful Death Laws: ARS 12-611 Through 12-613 + No Damage Cap"
headline: "Arizona Wrongful Death Statute: ARS 12-611 Through 12-613."
description: "Arizona wrongful death laws explained: ARS 12-611 creates the right to sue; ARS 12-612 sets beneficiary priority; Arizona Constitution Art. 2 §31 bans damage caps. 2-year deadline from date of death. Statewide intake (602) 654-0202."
...
faqs:
  - question: "Who can file a wrongful death lawsuit in Arizona?"
    answer: "ARS 12-612 establishes a priority system. The surviving spouse and children have first priority. If there's no spouse or children, the parents can file. If there are no parents, the personal representative of the estate can file. The priority is strict. Lower-priority beneficiaries can't file while higher-priority beneficiaries exist."
  - question: "Is there a cap on wrongful death damages in Arizona?"
    answer: "No. The Arizona Constitution, Article 2, Section 31, prohibits any law limiting damages for death or injury. Arizona juries can award whatever amount the evidence supports. This applies to both economic and non-economic damages. Punitive damages are also uncapped."
  - question: "How long do I have to file a wrongful death claim in Arizona?"
    answer: "Two years from the date of death under ARS 12-611. If a government entity is involved, a notice of claim must be served within 180 calendar days under ARS 12-821.01. Missing either deadline permanently bars that claim."
  - question: "What's the difference between a wrongful death claim and a survival action?"
    answer: "The wrongful death claim compensates the surviving family for their losses: lost income, loss of companionship, grief. The survival action compensates the deceased's estate for the deceased person's own pre-death damages: medical bills, lost wages, and pain and suffering experienced between the injury and death. Both are typically filed in the same lawsuit."
  - question: "Can I file a wrongful death claim if my family member was partially at fault?"
    answer: "Yes. Arizona's pure comparative negligence system (ARS 12-2505) reduces the recovery by the deceased person's percentage of fault but doesn't eliminate it. If the deceased was 30% at fault, the surviving family recovers 70% of the total damages."
  - question: "Are punitive damages available in wrongful death cases?"
    answer: "Yes, but only when the defendant's conduct rises beyond ordinary negligence to an \"evil mind\" standard. Drunk driving crashes, hit-and-run fatalities, and corporate decisions that consciously disregard safety risks can support punitive damages. Arizona doesn't cap punitive damages."
---
...
<DataTable
  headers={["Economic damage category", "What it covers"]}
  rows={[
...
<DataTable
  headers={["Claim type", "Key elements"]}
  rows={[
...
<DataTable
  headers={["Practical issue", "What it means for the family"]}
  rows={[
