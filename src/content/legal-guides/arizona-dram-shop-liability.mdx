---
title: "Arizona Dram Shop Laws: ARS 4-311 Liability + 1-Year Deadline"
description: "Arizona dram shop laws explained: ARS 4-311 holds bars liable for serving obviously intoxicated patrons; ARS 4-312 imposes a 1-year deadline—shorter than standard PI. Social hosts generally exempt. Statewide intake (602) 654-0202."
...
faqs:
  - question: "What is dram shop liability in Arizona?"
    answer: "Dram shop liability is the legal doctrine that allows people injured by drunk drivers to sue the bar or restaurant that served the driver alcohol. Arizona's dram shop law is in ARS 4-311. It applies when a licensed alcohol vendor served a patron who was obviously intoxicated, and that intoxication caused a crash."
  - question: "What does 'obviously intoxicated' mean?"
    answer: "Visibly impaired in ways a reasonable observer would notice: slurred speech, stumbling, glassy eyes, loud or aggressive behavior, difficulty handling money. The standard requires that the patron's impairment was apparent at the time they were served, not just that they were drunk by the time they left."
  - question: "Can I sue a homeowner who served alcohol to a drunk driver?"
    answer: "Generally no, in Arizona. Social host liability is much more limited than dram shop liability. The exception is serving alcohol to a minor (under 21), which can create civil liability for the host."
  - question: "How long do I have to file a dram shop case in Arizona?"
    answer: "One year under ARS 4-312. This is shorter than the standard two-year personal injury deadline. The dram shop clock and the personal injury clock run separately, so missing the one-year dram shop deadline doesn't bar the underlying personal injury claim against the driver, but it does eliminate the bar as a defendant."
  - question: "What damages are available in a dram shop case?"
    answer: "The same compensatory damages as any personal injury or wrongful death case: medical expenses, lost wages, pain and suffering, loss of consortium, funeral expenses. Punitive damages may also be available in cases involving especially egregious conduct by the licensee."
---
