...
description: "School bus crashes injure dozens of Arizona children each year. 180-day notice of claim required. Government immunity rules apply. Free consultation."
practiceArea: "Bus Accidents"
cluster: "vehicle-crashes"
clusterLabel: "Vehicle Crashes"
clusterOrder: 7
heroTitle: "$800K Settlement for a Five-Year-Old Left on a School Bus for Six Hours"
heroSubtitle: "Arizona bus accident attorneys who know the 180-day government claim deadline, immunity exceptions, and how to hold districts accountable."
...
**Driver negligence.** Speeding, distracted driving, failure to yield, running signals. The same negligence theories that apply to any motor vehicle crash apply to bus drivers.

**Supervision failures.** Children left on buses, injuries during boarding or exiting, incidents at unsupervised bus stops. The $800,000 AZ Law Now settlement involved a supervision failure where no one checked the bus after the route.

**Maintenance failures.** Brake failures, tire blowouts, mechanical defects. Bus operators have a duty to maintain vehicles in safe operating condition.

**Third-party driver crashes.** When another vehicle causes the crash, the at-fault driver's insurance is primary. But claims against the bus operator may also exist if driver positioning, speed, or evasive actions contributed to injuries.

**Dangerous conditions.** Poorly designed bus stops, missing crosswalks, inadequate signage around school zones. These claims often involve government entities and trigger the 180-day notice requirement.
...
If your child was injured in a bus crash in Arizona, call (602) 654-0202 for a free consultation. We understand the government claim process, the immunity exceptions, and the compressed deadlines. We don't charge unless we recover money for your family.
</Callout>
