---
title: "Arizona Bus Accident Laws: 180-Day Government Claims"
description: "Arizona bus accident laws explained: ARS 12-821.01 180-day notice; ARS 12-820 immunity. $800K school-bus precedent. Statewide intake (602) 654-0202."
...
faqs:
  ...
  - question: "What is the 180-day deadline for claims against Arizona government entities?"
    answer: "Arizona law requires people with personal injury claims against public entities or public employees to serve a written Notice of Claim within 180 days after the claim “accrues” (usually the injury date) under A.R.S. § 12-821.01(A). The notice must go to the person authorized to accept service for the agency or employee and must include basic facts plus a specific dollar amount to settle the claim. If someone misses the 180-day deadline, the claim is legally barred and no lawsuit may go forward, even though Arizona’s general statute of limitations is longer (A.R.S. § 12-821). Once the notice is filed, the claim is deemed denied after 60 days if the entity doesn’t accept it, and any lawsuit must then be filed within one year of accrual."
  - question: "Who investigates a school bus crash in Arizona?"
    answer: "Several agencies may investigate an Arizona school bus crash, often at the same time. Local law enforcement or the Arizona Department of Public Safety (AZDPS) typically handles the primary crash investigation and traffic citation decisions under Arizona traffic laws (for example, ARS Title 28). For school buses, AZDPS Student Transportation also requires the employer to notify DPS immediately and to submit a written School Bus Accident / Incident Report within 72 hours, as required by AAC R13‑13‑104(E)(2) and the DPS form updated in 2023. If the crash involves serious injuries, multiple deaths, or commercial carriers, federal agencies like the NTSB or FMCSA may conduct separate safety investigations, as seen in prior fatal Arizona bus crashes reported in 2024."
  - question: "Can a private bus company be held to a higher standard than a school district?"
    answer: "Arizona law generally holds private bus companies to at least the same safety standards as school districts, and some requirements can be stricter. Any carrier that transports students must follow federal motor carrier rules on driver qualifications, hours of service, and vehicle safety (see FMCSA regulations) plus Arizona’s school bus standards in ARS §28‑900 and related administrative rules. If a company operates as a “for‑hire” motor carrier, it must also meet additional insurance and registration requirements under ARS Title 28, Chapter 9. Courts and regulators can impose higher expectations on private firms in contracts or permits, for example stricter maintenance or background check rules, especially when they market themselves as specialized student transportation providers."
dataSources:
  - "Arizona Revised Statutes § 12-821.01: Claims Against Public Entities; Notice; Limitations. https://www.azleg.gov/ars/12/00821-01.htm"
  ...
  - "Nunez v. Professional Transit Management of Tucson, Inc., 229 Ariz. 117 (2012). https://law.justia.com/cases/arizona/supreme-court/2012/cv-11-0186-pr.html"
  ...
  - "National Highway Traffic Safety Administration. (2024). Traffic Safety Facts: School-Transportation-Related Crashes (2014-2023). https://crashstats.nhtsa.dot.gov/Api/Public/ViewPublication/813731.pdf"
  - "Federal School Bus Safety Act of 2025, S.828 / H.R.1828, 119th Congress. https://www.congress.gov/bill/119th-congress/senate-bill/828/text"
  - "InBuckeye.com. (2026, January 5). Report: Family Settles for $800,000 After Autistic Boy, 5, Left on School Bus. https://inbuckeye.com/community/report-family-settles-for-800000-after-autistic-boy-5-left-on-school-bus/"
---
...
<DataTable
  headers={["Other claim types", "How they work"]}
  rows={[
