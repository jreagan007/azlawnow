---
title: "Arizona Dog Bite Laws: ARS 11-1025 Strict Liability"
description: "Arizona dog bite laws explained: ARS 11-1025 strict liability; ARS 12-541 one-year deadline. Statewide intake (602) 654-0202."
...
primaryKeyword: "arizona dog bite lawyer"
...
faqs:
  ...
  - question: "Can I sue if a dog bit me while I was on public property in Arizona?"
    answer: "Arizona law allows people injured by dog bites in many public places to bring civil claims against the dog’s owner. Under Arizona’s strict liability statute, the owner of a dog that bites a person in a public place is liable for damages, regardless of the dog’s prior history or the owner’s knowledge of viciousness (A.R.S. § 11‑1025). The person usually must not have provoked the dog, and certain government police or military dogs have limited immunity while performing official duties (A.R.S. § 11‑1025(D)). In 2024, Maricopa County Animal Care and Control continued to instruct people to report dog bites so officials can document and investigate incidents. Potential damages in these cases typically include medical costs and other documented losses."
  - question: "What if a dog knocked me down and injured me but didn't actually bite me?"
    answer: "Arizona law can still allow a claim when a dog knocks someone down and causes injury, even if there was no bite. Liability often turns on negligence, such as whether the owner failed to control the dog or violated leash rules under local ordinances or Arizona’s leash law framework, ARS 11-1025, and cities and counties often add their own control rules. If the incident involved a dog at large, Arizona also treats running at large as a separate issue for dogs and other animals under ARS 11-1012. The injury still has to be proven with medical records, photos, and witness information, because falling injuries can range from bruises to fractures or head trauma."
  - question: "Do I need to report a dog bite to Maricopa County Animal Control?"
    answer: "Yes, Arizona law says any person with direct knowledge of a bite must report it immediately to the county enforcement agent, and Maricopa County Animal Care and Control handles those reports in Phoenix and much of the county (ARS 11-1014). Maricopa County says to report all dog and cat bites to the appropriate animal control office, even if the animal seems healthy and is quarantined, and routine bites usually go to MCACC rather than the county health department (Maricopa County Rabies guidance, 2025). MCACC says reports can be filed online or by phone at 602-506-7387, and field officers then investigate and begin the quarantine process."
dataSources:
...
<DataTable
  headers={["Exception", "How it works"]}
  rows={[
...
<DataTable
  headers={["Injury type", "Long-term impact"]}
  rows={[
...
<DataTable
  headers={["Severity tier", "Typical range", "What drives the value"]}
  rows={[
    ["Minor bites without scarring", "$15,000 to $50,000", "Puncture wounds that heal without surgical intervention, limited time off work."],
    ["Moderate bites with scarring or infection", "$50,000 to $150,000", "Surgical repair, scar revision, infection treatment, and extended recovery drive the value higher."],
