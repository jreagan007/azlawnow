...
ogImage: "/og/arizona-nursing-home-violations.webp"
readingTime: "11 min"
...
- **Actual harm that is not immediate jeopardy** (Level 3)
...
**RN hours per resident day.** This is the most important single number. RNs handle assessments, care planning, medication management, and clinical decision-making. Low RN hours mean fewer eyes on the residents who need the most attention.

**Weekend staffing.** CMS breaks out weekday versus weekend staffing. Many facilities drop staff levels on weekends. If a facility has 0.8 RN hours per resident day on weekdays and 0.3 on weekends, the weekend is when problems happen.

**Staff turnover.** CMS now publishes turnover rates for RNs and total nursing staff. High turnover means new staff who don't know the residents, higher error rates, and less continuity of care.
...
Click on a facility name to see the full profile. The profile includes the following.

**Health inspection details.** Every deficiency citation from the last three standard surveys plus any complaint investigations. Each citation shows the scope, severity, date, and a description of what the surveyor found.
...
**Staffing data.** RN hours, total nursing hours, weekend staffing, and staff turnover rates. Compared to state and national averages.

**Quality measures.** Clinical outcome data compared to state and national benchmarks.

**Ownership history.** Who owns the facility, who operates it, and when ownership has changed. Ownership changes matter because some companies acquire poorly performing facilities, rebrand them, and continue the same staffing patterns.
...
<FAQ>
  <Question q="Where can I look up a nursing home's inspection results?">
    CMS Care Compare at medicare.gov/care-compare. Search by facility name, city, or zip code. The profile shows star ratings, deficiency citations, penalty history, staffing data, and quality measures. All of it is free and public.
  </Question>
