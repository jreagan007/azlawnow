...
faqs:
  - question: "What should I do first after a wrong-way crash?"
    answer: "If you're injured, stay still and wait for paramedics. Call 911 if you're able. Don't confront the other driver. Photograph the scene if you can use your phone. Once you're medically stable, contact a personal injury attorney immediately. Evidence in wrong-way cases is extremely time-sensitive."
  - question: "What is dram shop liability?"
    answer: "Arizona's dram shop law (ARS 4-311 and 4-312) holds bars, restaurants, and liquor stores liable when they serve alcohol to someone who is obviously intoxicated and that person injures or kills someone. In wrong-way crashes where alcohol is involved, investigating where the driver was drinking often leads to a dram shop claim with access to the establishment's commercial insurance policy."
  - question: "Can we sue the bar that served the wrong-way driver?"
    answer: "Yes, if the evidence shows the bar served the driver when the driver was obviously intoxicated. The one-year statute of limitations for dram shop claims is shorter than the two-year personal injury deadline. Your attorney should investigate the driver's drinking locations immediately and send preservation letters to any identified establishments."
  - question: "What if the wrong-way driver didn't have insurance?"
    answer: "Your own uninsured motorist (UM) coverage applies. If a dram shop claim is viable, the establishment's commercial insurance is an additional source. Punitive damages may also be available against the driver personally if they have assets. Your attorney will identify every available source of compensation."
  - question: "How long do I have to file a wrong-way crash claim?"
    answer: "Two years for personal injury (ARS 12-542). Two years from date of death for wrongful death (ARS 12-611). One year for dram shop claims (ARS 4-312). And 180 days for claims against government entities (ARS 12-821.01). The one-year dram shop deadline is the one most families miss."
---
...
<DataTable
  headers={["Additional evidence", "What it proves"]}
  rows={[
...
<DataTable
  headers={["Additional source", "How it works"]}
  rows={[
...
<DataTable
  headers={["Infrastructure and background evidence", "Why it matters"]}
  rows={[
...
<DataTable
  headers={["Claim type", "Deadline", "Statute"]}
  rows={[
