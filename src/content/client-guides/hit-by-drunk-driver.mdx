...
faqs:
  ...
  - question: "How long do I have to file a wrongful death case in Arizona?"
    answer: "Two years from the date of death under ARS 12-611. The dram shop claim against the bar has only one year under ARS 4-312, so the timing matters for the bar but not for the underlying claim against the driver."
---
