...
relatedInvestigation: "/investigations/arizona-pedestrian-deaths-road-design/"
...
Pedestrian hit-and-runs are devastatingly common. The driver panics, flees, and leaves you on the pavement. Our [hit-and-run investigation](/investigations/hit-and-run-maricopa-county-data/) found that about 90% of hit-and-run crashes in Maricopa County go unsolved.
