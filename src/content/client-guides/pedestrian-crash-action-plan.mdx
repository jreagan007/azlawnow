...
relatedLegalGuide: "/legal-guides/arizona-pedestrian-rights/"
---
...
This guide goes beyond the basics. If you need the immediate steps (call 911, get the driver's info, go to the ER), we cover those in our [introductory pedestrian crash guide](/client-guides/hit-by-car-walking-action-plan/). This guide goes deeper: the medical priorities that get missed, the road design claims most families don't know exist, the UM/UIM insurance process when the driver fled, and the 180-day deadline that catches more families off guard than any other.
...
**Missing crosswalks.** Were you crossing a road with no marked crosswalk anywhere nearby? If the nearest crosswalk was a quarter mile away or more, the road design forced you to cross without one.

**Inadequate lighting.** Pedestrian crashes on unlit or poorly lit roads are disproportionately fatal. If the crash happened in a location where better lighting could have given the driver time to see you, the entity responsible for streetlight maintenance may bear responsibility.

**Speed design.** Wide, straight roads encourage high speeds even when the posted limit is 40 or 45 mph. If the road's design encouraged speeds that made it impossible for the driver to stop in time, the road design is part of the problem.

**Missing sidewalks.** Were you walking in the road because there was no sidewalk? In parts of the West Valley, major roads lack continuous sidewalks. Pedestrians are forced into travel lanes because the infrastructure doesn't provide an alternative.
...
**You don't have to own the car that insures you.** If you live with a family member who has an auto policy with UM coverage, that policy may extend to you as a household member. Check the policy terms.

**MedPay coverage** on your auto policy pays medical bills regardless of fault. It's typically $1,000 to $10,000 and processes quickly.

**Your health insurance** covers your treatment like any other injury. If you later recover a settlement, your health insurer may have subrogation rights to recoup what they paid. Your attorney negotiates this to minimize what you owe back.
...
**The driver.** Were they speeding? Distracted? Running a red light? Turning without yielding to pedestrians? The driver's behavior is usually the primary liability factor.

**The road.** Were the conditions safe for pedestrians? Were crosswalks, sidewalks, lighting, and signals adequate? If not, the government entity responsible for the road may share liability.
...
For more on your [legal rights as a pedestrian in Arizona](/legal-guides/arizona-pedestrian-rights/), including comparative fault rules and ARS 28-796, read Brandon's legal guide.
