...
faqs:
  - question: "How can I tell if the truck driver was fatigued?"
    answer: "Key indicators include no braking before impact, the truck drifting out of its lane, the crash occurring between 2:00 AM and 6:00 AM or 2:00 PM and 4:00 PM, and the driver appearing confused or disoriented afterward. The definitive evidence is in the ELD data, which shows exactly how many hours the driver was on the road before the crash."
  - question: "What is ELD data and why does it matter?"
    answer: "An Electronic Logging Device records a commercial driver's driving time, on-duty time, off-duty time, and rest periods. Federal law requires it for most commercial vehicles. ELD data shows whether the driver exceeded legal driving limits before the crash. It's the most important piece of evidence in a fatigued trucker case, and it can be overwritten if not preserved quickly."
  - question: "How quickly does evidence disappear in truck crash cases?"
    answer: "ELD data can be overwritten within days. Dashcam footage overwrites every 48 to 72 hours. Dispatch system logs may be purged on a rolling basis. Your attorney should send preservation letters within 24 hours of the crash to prevent the carrier from losing, overwriting, or destroying electronic evidence."
  - question: "Can I sue the trucking company, not just the driver?"
    answer: "Yes. The trucking company (carrier) often carries more liability than the driver. If the carrier set an unrealistic schedule, failed to monitor hours-of-service compliance, hired a driver with a poor safety record, or neglected vehicle maintenance, the carrier is responsible. Carrier insurance policies are typically $1 million or more."
  - question: "Should I talk to the trucking company's insurance adjuster?"
    answer: "No. You aren't required to give a recorded statement, sign medical authorizations, or discuss your injuries with the carrier's insurer. Politely decline and tell them your attorney will be in contact. Everything you say can be used to reduce your compensation."
---
...
<DataTable
  headers={["Additional fatigue signal", "What to look for"]}
  rows={[
...
<DataTable
  headers={["Driver-specific evidence", "Why it matters"]}
  rows={[
...
<DataTable
  headers={["What you can decline", "Why it matters"]}
  rows={[
...
<DataTable
  headers={["Documentation", "Why it matters"]}
  rows={[
