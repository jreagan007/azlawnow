...
headline: "Arizona Pedestrian Deaths Are Nearly Twice the National Average. The Roads Were Designed That Way."
...
<FAQ>
  ...
  <Question q="What if the driver left the scene after hitting me?">
    Arizona's hit-and-run statutes (ARS 28-661 through 28-665) make it a crime for a driver to leave the scene. A hit-and-run causing death is a Class 3 felony. If the driver is never found, your own auto insurance uninsured motorist coverage may cover your injuries. Contact an attorney to help navigate the claim within the one-year window that applies under most UM policy terms.
  </Question>

  <Question q="Does Arizona have damage caps on pedestrian injury cases?">
