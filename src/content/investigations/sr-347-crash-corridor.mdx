...
methodology:
  dataSources:
    - "ADOT 2024 Arizona Motor Vehicle Crash Facts (statewide totals)"
    - "ADOT Crash Data Hub corridor-level pulls, April 2026"
    - "ADOT SR-347 Corridor Study, 2023 (design context and traffic projections)"
    - "FMCSA Analysis and Information Online carrier safety data"
    - "U.S. Census Bureau ACS 5-Year Estimates Table S0801 (commuting flows)"
    - "Pinal County 5-Year Plan corridor notice, 2025"
  processing: "N = approximately 381 reportable crashes on SR-347 between Maricopa City and the I-10 interchange across calendar years 2022-2024 (3-year window), drawn from ADOT corridor-level Crash Data Hub pulls. Average works out to 127 per year. Time window: 2022-2024. Primary source agency: ADOT, with truck-mix percentages cross-checked against FMCSA carrier data. Excluded: incidents on connecting local streets outside the milepost limits and incidents recorded only by Pinal County Sheriff that did not flow into the ADOT crash database."
  limitations:
    - "ADOT corridor pulls may misclassify crashes that occur within the I-10 interchange merge area"
    - "Truck-mix percentages depend on FMCSA self-reporting that lags real-world fleet changes"
    - "Three-year averaging smooths year-over-year volatility tied to construction zone shifts on the corridor"
  peerReview: "Reviewed against ADOT, FMCSA, Census Bureau ACS, and Pinal County primary sources. Internal review by Brendan Franks."
...
faqs:
  ...
  - question: "Is Arizona an at-fault state for car accidents?"
    answer: "Yes. Arizona follows a fault-based system, meaning the driver who caused the crash is financially responsible for injuries and damages. Arizona also applies pure comparative negligence under ARS 12-2505, so you can recover compensation even if you were partly at fault. Your award is reduced by your percentage of fault, but it's never eliminated entirely."
  - question: "Who pays when you're hit by an uninsured driver in Arizona?"
    answer: "If the at-fault driver has no insurance, your own uninsured motorist (UM) coverage may apply. Arizona requires insurers to offer UM coverage, though drivers can waive it in writing. About 12% of Arizona drivers carry no insurance. Under ARS 12-558, if you were also uninsured at the time of the crash, you can still recover economic damages like medical bills and lost wages, but not non-economic damages like pain and suffering."
dataSources:
