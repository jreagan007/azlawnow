...
description: "SR-347 funnels virtually all Maricopa commuter traffic into a single interchange at I-10. The merge geometry, the speed differential, and the truck mix create one of the most consistent crash zones in Pinal County."
author: "brendan-franks"
category: "infrastructure"
ogImage: "/og/sr-347-i-10-interchange.png"
image: "/images/heroes/dj-sr347-i10-interchange.webp"
...
<KeyFacts>
  ...
  <Fact>ADOT corridor widening is planned. Construction funding is not allocated. Realistic start: 2029.</Fact>
</KeyFacts>
...
Preliminary engineering is underway. Construction funding is not allocated. ADOT's programming documents put a realistic construction start at 2029, which means Maricopa commuters will be navigating the current configuration for several more years at minimum.
