...
methodology:
  dataSources:
    - "ADOT 2024 Arizona Motor Vehicle Crash Facts (statewide hit-and-run totals)"
    - "AAA Foundation Understanding the Increase in Fatal Hit-and-Run Crashes, March 2026"
    - "City of Phoenix 2023 Traffic Collision Summary"
    - "ARS 28-661 through 28-663 (Arizona hit-and-run statutes)"
    - "Insurance Research Council Uninsured Motorists Study, 2024"
    - "AAA Foundation Hit-and-Run Crashes: Prevalence, Contributing Factors, and Countermeasures, 2018"
  processing: "N = 16,136 reported hit-and-run crashes in Arizona in calendar year 2024, drawn from ADOT's statewide crash facts publication. Fatality subset: 86 deaths and 4,202 injuries on the same source. Maricopa County share estimated at 73% based on ADOT's standing county-of-occurrence distribution. National solve-rate context comes from the AAA Foundation's March 2026 fatal hit-and-run release. Sample frame excludes property-damage-only incidents below the ARS 28-667 reporting threshold."
  limitations:
    - "ADOT statewide totals exclude unreported minor hit-and-run incidents and crashes on tribal land"
    - "AAA Foundation national solve rate is an estimate; agency-level clearance data is not uniformly published"
    - "Phoenix Traffic Collision Summary lags by one year, so 2024 city-level cuts are not yet final"
  peerReview: "Reviewed against ADOT, AAA Foundation, Phoenix Streets, and ARS primary sources. Internal review by Brendan Franks."
...
faqs:
  - question: "How many hit-and-run crashes happen in Arizona?"
    answer: "In 2024, Arizona recorded 16,136 hit-and-run crashes, killing 86 people and injuring 4,202. That's one in eight crashes statewide. Maricopa County accounts for roughly 73% of all crashes in Arizona, putting the county's estimated share at over 11,700 hit-and-runs per year."
  - question: "What percentage of hit-and-run cases are solved?"
    answer: "Nationally, roughly 10% of hit-and-run cases are solved. For fatal hit-and-runs, the AAA Foundation found that 53% of drivers were never identified. The solve rate depends on available evidence: surveillance footage, witness accounts, and distinctive vehicle damage."
  - question: "What are the penalties for hit-and-run in Arizona?"
    answer: "Under ARS 28-661, a fatal hit-and-run where the driver caused the crash is a Class 2 felony carrying 3 to 12.5 years in prison. If the driver didn't cause the crash but fled, it's a Class 3 felony (2 to 8.75 years). Injury hit-and-runs are Class 5 felonies. Property-damage-only is a Class 1 misdemeanor."
  - question: "Why do drivers flee after a crash?"
    answer: "The AAA Foundation found that 40% of identified hit-and-run drivers in fatal crashes had no valid license, and nearly three in five were driving a vehicle not registered in their name. Research shows impaired drivers flee specifically to avoid DUI detection. The penalty for fleeing, if caught later while sober, may be less severe than the penalty for staying at the scene while intoxicated."
  - question: "What should I do after a hit-and-run?"
    answer: "Get medical attention immediately. Document everything: vehicle color, make, direction of travel, any plate information. Check for surveillance cameras at nearby businesses. File a police report the same day. Contact an attorney to help with the UM/UIM insurance claim against your own policy."
  - question: "Does my insurance cover a hit-and-run if the driver is never found?"
    answer: "If you have uninsured motorist (UM) coverage on your auto policy, it covers hit-and-run injuries when the driver is never identified. Arizona doesn't require UM coverage, and drivers can decline it. Without UM coverage, there may be no source of compensation if the hit-and-run driver is never found."
---
...
<DataTable
  headers={["Crash severity", "Charge", "Prison range", "License impact"]}
  rows={[
