...
methodology:
  dataSources:
    - "CMS Care Compare nursing home directory, accessed April 9, 2026"
    - "CMS Health Deficiency Citations dataset (data.cms.gov r5ix-sfxw)"
    - "CMS Nursing Home Penalties dataset (data.cms.gov g6vv-u9sr)"
    - "CMS Payroll-Based Journal daily nurse staffing, 2026 release"
    - "AZ CareCheck licensed facility search, ADHS, April 9, 2026"
    - "Arizona DES Adult Protective Services Year in Review, 2024"
  processing: "Sample frame: every Medicare-certified nursing home in Maricopa County listed on CMS Care Compare as of April 9, 2026 (N ≈ 130 facilities). Time window: rolling 36-month deficiency window per CMS standard reporting, with penalty totals current through Q1 2026. Excluded: assisted living facilities (regulated by ADHS only, no CMS oversight), and facilities serving residents under age 18. Primary source agency: CMS Quality, Safety & Oversight, cross-referenced against ADHS licensing actions on AZ CareCheck."
  limitations:
    - "Care Compare excludes assisted living and memory care facilities not certified for Medicare or Medicaid"
    - "Self-reported PBJ staffing data is not independently audited and may overstate front-line hours"
    - "ADES Adult Protective Services case totals exclude reports closed at intake or screened out before investigation"
  peerReview: "Reviewed against CMS Care Compare, ADHS AZ CareCheck, and ADES APS primary sources. Internal review by Brendan Franks."
...
dataSources:
  ...
  - "Centers for Medicare & Medicaid Services. Quality, Safety & Oversight. https://www.cms.gov/medicare/health-safety-standards/quality-safety-oversight-certification-automation-system"
...
faqs:
  - question: "Where can I look up a nursing home's inspection results?"
    answer: "CMS Care Compare at medicare.gov/care-compare. Search by facility name, city, or zip code. The profile shows star ratings, deficiency citations, penalty history, staffing data, and quality measures. All of it's free and public."
  - question: "What does a one-star rating mean?"
    answer: "One star means \"much below average\" based on the CMS methodology. It indicates the facility's combined performance on health inspections, staffing, and quality measures is significantly worse than most nursing homes nationally. One-star facilities have typically received serious deficiency citations or have very low staffing levels."
  - question: "How often are nursing homes inspected in Arizona?"
    answer: "Standard surveys happen approximately every 12 to 15 months. Complaint investigations happen on an as-needed basis, with immediate jeopardy complaints triggering on-site investigation within two days. Revisit surveys verify that previously cited deficiencies have been corrected."
  - question: "What's the difference between CMS complaints and APS reports?"
    answer: "CMS complaints go through ADHS and focus on whether the facility is meeting federal care standards. APS reports go through the Arizona Department of Economic Security and focus on whether a specific vulnerable adult has been abused, neglected, or exploited. They're separate systems. Reporting to one doesn't trigger the other. Report to both if you suspect a problem."
  - question: "Can a nursing home lose its Medicare certification?"
    answer: "Yes. CMS can terminate a facility's Medicare and Medicaid certification for persistent noncompliance with federal standards. Termination forces the facility to discharge or transfer all Medicare and Medicaid residents. It's the most severe enforcement action available and is typically a last resort after other penalties have failed to produce compliance."
  - question: "What should I do if I find problems in a facility's data?"
    answer: "Visit the facility. Talk to your family member privately. Look for signs of neglect or abuse (unexplained injuries, weight loss, unsanitary conditions). Document what you find. If you see evidence of abuse or neglect, report to ADHS and APS. Consult an attorney if you believe your family member has been harmed."
---
...
A facility that was "Desert Vista Care" with a one-star rating in 2023 can reopen as "Desert Vista Rehabilitation" in 2024 with a blank slate on Google but the same ownership group, the same director of nursing, and the same nurse-to-resident ratio. The CMS ownership history is how you catch that.
