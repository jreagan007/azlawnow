---
title: "AZ Schools Bought MERV 13. They Don't Work"
headline: "AZ Schools Bought MERV 13 Filters. Without a Sealed Housing They Fail."
...
keyTakeaway: "ASHRAE Standard 52.2 sets the MERV rating using a sealed laboratory test of the filter media. It doesn't test, evaluate, or require any housing or gasket performance in the field.\n\nASHRAE Standard 241-2023 puts the consequence in plain English: air that bypasses an unsealed filter doesn't get cleaned, and the system performs as if a lower MERV had been installed.\n\nEPA tightened the annual PM2.5 NAAQS to 9 micrograms per cubic meter in February 2024. The World Health Organization's 2021 guideline is 5. Maricopa County is in serious non-attainment under the Clean Air Act for PM10.\n\nPeer-reviewed research links PM2.5 exposure to higher all-cause mortality, slower cognitive development in children, autism risk, and IQ loss. No Arizona school district appears to publish a single PM2.5 reading from inside its own buildings. The wellness claim is mechanical. The data isn't."
...
<EmbedAsset
  src="/embeds/merv-13-master-1200x675.png"
  ...
  storyUrl="https://azlawnow.com/investigations/arizona-schools-merv-13-filter-bypass/"
  caption="pm2-5-air-quality-standards-epa-vs-who-2024"
