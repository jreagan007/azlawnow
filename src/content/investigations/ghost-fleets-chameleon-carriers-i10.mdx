---
title: "Ghost Fleets on I-10: Chameleon Carriers AZ"
headline: "Ghost Fleets on I-10: How Chameleon Carriers Hide Their Records."
...
ogImage: "/og/ghost-fleets-chameleon-carriers-i10.png"
readingTime: "14 min"
...
faqs:
  - question: "What is a chameleon carrier?"
    answer: "A chameleon carrier is a trucking company that dissolves after accumulating safety violations and reincarnates under a new name and DOT number. Same trucks, same drivers, clean record. The practice erases crash history, violation records, and out-of-service orders that would otherwise flag the carrier for enforcement action."
  - question: "How common are chameleon carriers?"
    answer: "Trucking safety consultant Rob Carpenter estimates 10 to 20% of the 700,000 trucking companies in the US operate \"somewhere in the spectrum\" of chameleon carrier behavior. Fusable, a risk assessment firm, found that chameleon carriers are four times more likely to be involved in a crash."
  - question: "How many truck crashes happen in Arizona each year?"
    answer: "Arizona reported 2,750 crashes involving large trucks and buses in 2024. FMCSA data shows 63 fatal commercial vehicle crashes on Arizona state highways in 2023 where the CMV driver was at fault. Maricopa County accounts for the largest share of these crashes."
  - question: "Why is I-10 through Arizona especially vulnerable?"
  ...
  - question: "What should I do if I'm hit by a truck on I-10?"
  ...
  - question: "What is the 8 70 rule?"
    answer: "The 70-hour / 8-day rule is a federal hours-of-service limit that applies to many interstate truck and bus drivers who pass through or operate in Arizona. Under FMCSA regulations, a property-carrying commercial driver may not drive after being on duty 70 hours in any 8 consecutive days, and a new 8-day period can restart after 34 or more consecutive hours off duty (49 C.F.R. § 395.3; FMCSA summary of HOS rules, 2024). “On duty” time includes both driving and other work for a motor carrier, not just time behind the wheel. Federal regulators created this limit to reduce fatigue-related crashes, which remain a concern on Arizona highways according to ADOT crash data for 2024."
  - question: "How long does it take to settle a trucking accident case?"
    answer: "Trucking crash settlements in Arizona often take several months to more than a year, depending on injury severity, disputed fault, and how many parties and insurers are involved. Less complex claims with clear liability and shorter medical treatment sometimes resolve within about 6 to 9 months, which is consistent with national estimates reported in 2024. Cases involving serious injuries, long‑term treatment, or litigation can take a year or longer. Arizona generally allows people injured in truck crashes two years to file a personal injury lawsuit (ARS § 12‑542), so insurers may negotiate up until that deadline and sometimes beyond if a suit is filed. Once parties agree on an amount, payment usually follows within a few weeks, after release documents are signed."
  - question: "Is it better to settle or sue in an accident with a company vehicle?"
    answer: "Arizona law allows people injured by a company vehicle to resolve claims through settlement or a lawsuit, and most motor vehicle claims settle before trial according to national civil case data. Settlement can provide faster payment and less uncertainty, especially when liability is clear and insurance coverage is adequate, which is common for commercial policies regulated under federal rules for larger trucks (see FMCSA minimum financial responsibility, 49 C.F.R. Part 387). Suing in Arizona may become more likely if liability is disputed, injuries are severe, or the insurer offers less than documented medical bills, lost income, and other losses. A lawsuit must comply with Arizona’s two year general personal injury limitations period (ARS § 12‑542), although shorter deadlines can apply if a public entity owned the vehicle."
---
